...
.DESCRIPTION
    This script installs CMake using winget package manager.
...
try {
    ...
    $result = winget install --id Kitware.CMake --silent --accept-source-agreements --accept-package-agreements 2>&1
    ...
    Write-Host "Error installing CMake: $_" -ForegroundColor Red
    exit 1
}
