...
.DESCRIPTION
    This script installs Rust using winget package manager.
...
try {
    ...
    $result = winget install --id Rustlang.Rust.MSVC --silent --accept-source-agreements --accept-package-agreements 2>&1
