# LosslessCut Installation Script
...
try {
    ...
    Write-Host "  [i] Please install $AppName manually from https://github.com/mifi/lossless-cut" -ForegroundColor Cyan
