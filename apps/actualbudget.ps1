# Actual Budget Installation Script
...
$WingetId = "ActualBudget.ActualBudget"
...
try {
    ...
    Write-Host "  [i] Please install $AppName manually from https://actualbudget.com/" -ForegroundColor Cyan
