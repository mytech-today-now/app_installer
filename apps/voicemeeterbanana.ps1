...
.NOTES
    File Name      : voicemeeterbanana.ps1
    Author         : myTech.Today
    Version        : 1.0.0
#>
...
if (-not ($IsWindows -or $env:OS -match 'Windows')) {
    Write-Host "[INFO] VoiceMeeter Banana is only available for Windows." -ForegroundColor Yellow
    exit 0
}

$ErrorActionPreference = 'Stop'

$AppName = 'Voicemeeter Banana'
$WingetId = 'VB-Audio.Voicemeeter.Banana'
