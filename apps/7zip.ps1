...
.DESCRIPTION
    This script installs 7-Zip using winget package manager.
...
try {
    ...
    $result = winget install --id 7zip.7zip --silent --accept-source-agreements --accept-package-agreements 2>&1
