...
.DESCRIPTION
    This script installs Chromium using winget package manager.

.NOTES
    File Name      : chromium.ps1
    Author         : myTech.Today
    Version        : 1.0.0
...
try {
    ...
    $result = winget install --id Hibbiki.Chromium --silent --accept-source-agreements --accept-package-agreements 2>&1
    ...
    Write-Host "Error installing Chromium: $_" -ForegroundColor Red
    exit 1
}
