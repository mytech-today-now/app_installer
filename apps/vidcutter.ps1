...
$AppName = "VidCutter"
$WingetId = "OzmosisGames.VidCutter"
...
try {
    ...
    Write-Host "  [i] Please install $AppName manually from https://github.com/ozmartian/vidcutter" -ForegroundColor Cyan
