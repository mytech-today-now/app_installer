# Streamlabs Desktop Installation Script
...
$AppName = "Streamlabs Desktop"
$WingetId = "Streamlabs.StreamlabsOBS"
...
try {
    ...
    Write-Host "  [i] Please install $AppName manually from https://streamlabs.com/" -ForegroundColor Cyan
