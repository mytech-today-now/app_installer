...
if (-not ($IsWindows -or $env:OS -match 'Windows')) {
    Write-Host "[INFO] VMware Workstation Player is only available for Windows." -ForegroundColor Yellow
    exit 0
}

$ErrorActionPreference = 'Stop'

$AppName = 'VMware Workstation Player'
