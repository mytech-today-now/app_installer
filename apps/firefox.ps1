...
.DESCRIPTION
    This script installs Mozilla Firefox using winget package manager.
...
try {
    ...
    $result = winget install --id Mozilla.Firefox --silent --accept-source-agreements --accept-package-agreements 2>&1
