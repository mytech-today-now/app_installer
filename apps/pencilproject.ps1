# Pencil Project Installation Script
...
$AppName = "Pencil Project"
$WingetId = "Pencil.Pencil"
...
try {
    ...
    Write-Host "  [i] Please install $AppName manually from https://pencil.evolus.vn/" -ForegroundColor Cyan
