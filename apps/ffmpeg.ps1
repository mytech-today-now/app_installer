...
.DESCRIPTION
    This script installs FFmpeg using winget package manager.
...
try {
    ...
    $result = winget install --id Gyan.FFmpeg --silent --accept-source-agreements --accept-package-agreements 2>&1
