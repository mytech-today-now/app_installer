...
.DESCRIPTION
    This script installs LibreOffice using winget package manager.
...
try {
    ...
    $result = winget install --id TheDocumentFoundation.LibreOffice --silent --accept-source-agreements --accept-package-agreements 2>&1
    ...
    Write-Host "Error installing LibreOffice: $_" -ForegroundColor Red
    exit 1
}
