# SoftPerfect Network Scanner Installation Script
...
$AppName = "SoftPerfect Network Scanner"
$WingetId = "SoftPerfect.NetworkScanner"
...
try {
    ...
    Write-Host "  [i] Please install $AppName manually from https://www.softperfect.com/products/networkscanner/" -ForegroundColor Cyan
