...
.DESCRIPTION
    This script installs GitHub Desktop using winget package manager.
...
try {
    ...
    $result = winget install --id GitHub.GitHubDesktop --silent --accept-source-agreements --accept-package-agreements 2>&1
    ...
    Write-Host "Error installing GitHub Desktop: $_" -ForegroundColor Red
    exit 1
}
